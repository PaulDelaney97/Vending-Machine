 ...
 * @author ahill
 */
// My own UserIoImplementation was a little messy - I have chosen to use the
// provided one to ensure accuracy of the program. I will be implementing a new
// method readBigDecial in this file.
